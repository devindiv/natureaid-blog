    ...
    <div className="text-slate-800">
      <Container>
        <div className="container mx-auto px-4 py-8 max-w-3xl">
          ...
          <p className="mb-4">Last updated: April 28, 2024</p>
          <p>
          ...
          <h3 className="text-xl font-semibold my-4">Definitions</h3>
          ...
          <ul className="flex flex-col space-y-4 list-disc">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Natureaid, Kolkata, West Bengal.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to NatureAid, accessible from{" "}
                <a
                  href="https://www.natureaid.net"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.natureaid.net
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className="text-base font-semibold mb-4">Personal Data</h4>
          <p>
          ...
          <h4 className="text-base font-semibold my-4">Usage Data</h4>
          ...
          <h4 className="text-base font-semibold my-4">Law enforcement</h4>
          <p>
          ...
          <h2 className="text-2xl font-bold my-4">Children's Privacy</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold my-4">Links to Other Websites</h2>
          <p>
          ...
          <ul>
            <li>By email: contact@natureaid.net</li>
          </ul>
        </div>
      </Container>
    </div>
